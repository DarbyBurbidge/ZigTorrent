// code is attributed to dmgk
// https://github.com/dmgk/zig-getopt/
//
// The goal for this project is to write a BitTorrent Client
// Not to reinvent the wheel. Had I chosen a different language
// and not one currently in development, I would have had access
// to getopt out of the box.
